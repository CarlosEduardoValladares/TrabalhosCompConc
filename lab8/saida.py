...
le.escritorSaindo(2)
le.escritorEscrevendo(1)
print('Thread Escritor - Novo valor atribuído: {0}'.format(le.escritorEscrevendo(3)
print('Novo valor atribuído: {0}'.format(3))
le.escritorSaindo(3)
le.escritorEscrevendo(1)
print('Novo valor atribuído: {0}'.format(1))
le.escritorSaindo(1)
le.leitorLendo(1)
print('O inteiro lido é impar: {0}'.format(1))
le.leitorSaindo(1)
le.leitorLendo(4)
print('O inteiro lido é impar: {0}'.format(1))
le.leitorSaindo(4)
...
le.leitorSaindo(3)
le.escritorEscrevendo(2)
print('Novo valor atribuído: {0}'.format(2))
le.escritorSaindo(2)
le.leitorLendo(2)
print('O inteiro lido é par: {0}'.format(2))
le.leitorSaindo(2)
)
print('Thread Leitor - O inteiro lido é par: {0}'.format(2))
le.leitorSaindo(3)
